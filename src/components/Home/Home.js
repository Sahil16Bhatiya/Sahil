    ...
    <IconContext.Provider value={{ size: "1rem" }}>
      <StyledHome id="home">
        ...
        <p>
          ...
          <span className="responsive">e</span> Websites. (MERN Stack)
        </p>
            ...
            <div className="cd-product-viewer-wrapper" data-frame={16} data-friction="0.33">
              <div>
                <figure className="product-viewer">
                  ...
                  <div className="product-sprite" data-image="https://codyhouse.co/demo/360-degrees-product-viewer/img/alfa.png" />
                </figure>   
              </div>  
            </div>  
          </div> 
